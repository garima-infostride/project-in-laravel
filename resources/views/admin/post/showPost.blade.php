    ...
    <tbody>
        @foreach ($posts as $post )
            <tr>
                ...
                <td><img src="{{ URL::asset("uploads/{$post->image}") }}"  style="height: 50px;width:50px;" alt="image"></td>
                <td>
                    <a href="{{ route('post-edit') }}/{{ $post->id }}" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
                    <a href="" class="btn btn-primary btn-xs deletepost" image="{{ $post->image }}"
