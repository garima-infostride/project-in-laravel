    ...
    <div class="x_panel">
        ...
        <div class="x_content">
            <div class="form-group has-feedback" style="position: relative;">
                ...
                {!! Form::text('title','about',['class'=>'form-control','required'=>'required','readonly'=>'readonly']) !!}  
            ...
            <div class="form-group has-feedback" style="position: relative;">
                <label  class="hws_form_label">Section Section :</label><br>
                <label  class="hws_form_label">Title :</label>
                ...
                @endif
                <label  class="hws_form_label">Sub Title:</label>
                {!! Form::hidden('txt_name[]','second_text') !!}
                {!! Form::text('second_text','',['class'=>'form-control',]) !!}
                @if ($total_row)
                @foreach ($page as $value )
                    @if ($value->section_title=='second_text')
                    {!! Form::text('second_text',$value->data,['class'=>'form-control',]) !!}  
                    @endif                   
                @endforeach     
                @endif
            </div>
